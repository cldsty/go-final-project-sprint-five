...
func (w Walking) Calories() float64 {
	return ((CaloriesWeightMultiplier*w.Weight + math.Pow(w.meanSpeed()*KmHInMsec, 2) /
...
// Формула расчета:
// длина_бассейна * количество_пересечений / м_в_км
func (s Swimming) distance() float64 {
	return float64(s.LengthPool * s.CountPool) / MInKm
}
// Переопределил метод, так как иначе расчеты не сходились с указанной в задании функцией meanSpeed для рассчета дистанции.
